...
class PatientService {
  ...
  static Future add(Patient patient) async {
    return await http.post(Uri.parse(newPath + "/add"),headers: Environment.HEADERS, body: json.encode(patient));
  }

  static Future update(Patient patient) async {
    return await http.post(Uri.parse(newPath + "/update"),headers: Environment.HEADERS, body: json.encode(patient));
  }
